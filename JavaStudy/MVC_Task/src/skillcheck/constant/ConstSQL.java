...
public final class ConstSQL {
    ...
    public static final String SELECT_BASE = "SELECT empid, password, name, mail, programinglanguage,comment FROM employee_table";
    /** 社員情報一覧取得用クエリ: 削除されていない社員情報を社員番号順に取得 */
    public static final String SELECT_BY_DELETE_FLG_ZERO = "SELECT * FROM employee_table WHERE deleteFlg = '0' ORDER BY empId";
    /** 社員番号を条件とするクエリ: 完全一致 */
    public static final String SELECT_BY_EMPID = " SELECT * FROM employee_table WHERE empId = ? AND deleteFlg = '0'";
